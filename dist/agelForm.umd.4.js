((typeof self !== 'undefined' ? self : this)["webpackJsonpagelForm"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpagelForm"] || []).push([[4],{
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-radio-group',_vm._g(_vm._b({ref:"ref",staticClass:"agel-radio-group",attrs:{"value":_vm.value},on:{"input":_vm.input}},'el-radio-group',_vm.$attrs,false),_vm.on),_vm._l((_vm.options),function(option){return _c(_vm.radioComponent,_vm._b({key:option.value,tag:"component",attrs:{"label":option.value}},'component',option,false),[_vm._v("\n    "+_vm._s(option.label)+"\n  ")])}),1)}
var staticRenderFns = []
...
/* harmony default export */ var agel_radio_group = __webpack_exports__["default"] = (component.exports);
