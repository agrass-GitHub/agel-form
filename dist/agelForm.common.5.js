((typeof self !== 'undefined' ? self : this)["webpackJsonpagelForm"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpagelForm"] || []).push([[5],{
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-select',_vm._g(_vm._b({ref:"ref",staticClass:"agel-select",attrs:{"value":_vm.value},on:{"input":_vm.input}},'el-select',_vm.$attrs,false),_vm.on),_vm._l((_vm.options),function(option){return _c('el-option',_vm._b({key:option.value},'el-option',option,false))}),1)}
var staticRenderFns = []
...
/* harmony default export */ var agel_select = __webpack_exports__["default"] = (component.exports);
